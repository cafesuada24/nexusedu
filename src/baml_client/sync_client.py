...
class BamlStreamClient:
    ...
    def GenerateSQL(self, message: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[typing.Union["stream_types.GeneratedSQL", "stream_types.RequestDBSchema"], typing.Union["types.GeneratedSQL", "types.RequestDBSchema"]]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="GenerateSQL", args={
            "message": message,
        })
        return baml_py.BamlSyncStream[typing.Union["stream_types.GeneratedSQL", "stream_types.RequestDBSchema"], typing.Union["types.GeneratedSQL", "types.RequestDBSchema"]](
          __result__,
