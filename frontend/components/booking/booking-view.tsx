...
export function BookingView({
  ...
  return (
    <div className="grid gap-4 lg:grid-cols-[380px_1fr]">
      <Card className="rounded-2xl border-border/60">
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="font-serif text-lg">TS. Lê Hà</CardTitle>
              <CardDescription>Cố vấn học tập · Khoa CNTT</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent className="grid gap-4">
          ...
          <div>
            <p className="mb-2 text-sm font-medium">Hình thức gặp</p>
            <RadioGroup
              value={mode}
            ...
            >
              ...
              <Label
                ...
                className={cn(
                  "flex cursor-pointer items-center gap-3 rounded-xl border border-border p-3 transition-colors hover:bg-accent/60",
                  mode === "inperson" && "border-primary bg-primary/5",
                )}
              >
                <RadioGroupItem id="m-inperson" value="inperson" />
      ...
      <Card className="rounded-2xl border-border/60">
        <CardHeader>
          <CardTitle className="font-serif text-lg">Chọn ngày & giờ</CardTitle>
          <CardDescription>
        ...
        <CardContent className="grid gap-6 md:grid-cols-[auto_1fr]">
          ...
          <div>
            <div className="mb-3 flex items-center justify-between">
              ...
              >
                {date && isSameDay(date, today) ? "Hôm nay" : "Sắp tới"}
              </Badge>
            </div>
            ...
            <p className="mt-3 text-xs text-muted-foreground">
              Khung giờ đồng bộ từ &ldquo;Giờ làm việc&rdquo; cố vấn đã cấu hình.
              Khung giờ xám là đã được đặt.
            </p>
